...
public abstract class GenericDao<T> extends UniversalDao {
	...
	public T getByBean(Object obj,String excludeProperty) throws SecurityException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException{
		...
		for(int i=0;i<fieldsList.size();i++){
			...
			if(!ValueWidget.isNullOrEmpty(excludeProperty)&&f.getName().equals(excludeProperty)){
				continue;
			}
	...
	public T getLazy(int id, String propertyName) {
		return (T) this.sessionFactory.getCurrentSession().createCriteria(clz)
	...
	private Criteria getCriteria(Object obj,
		...
		return getCriteria(clz, obj, includeZeros, first, maxRecordsNum);
	}
	 ...
	 * @return
	 */
	public List<T> getFrontTVVideos(Map condition,int front){
	...
	public T load(int id) {
		...
		return (T) this.sessionFactory.getCurrentSession().load(clz, id);
	}
